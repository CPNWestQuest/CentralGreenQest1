(() => {
  ...
  const ITEMS = [
    {
      id: "tissue",
      name: "กระดาษทิชชู่",
      image: "assets/tissue.jpg?v=20260717",
      bin: "general",
      explanation: "กระดาษทิชชู่ใช้แล้วเป็นขยะทั่วไป จึงใส่ถังสีน้ำเงิน"
    },
    {
      id: "food_box",
      name: "กล่องใส่อาหารเปื้อน (เทเศษอาหารออกแล้ว)",
      image: "assets/food_box.jpg",
      bin: "burnable",
      explanation: "กล่องใส่อาหารเปื้อนที่เทเศษอาหารออกแล้ว เป็นขยะเชื้อเพลิง จึงใส่ถังสีเทา"
    },
    {
      id: "bubble_tea",
      name: "แก้วชาไข่มุก",
    ...
    {
      id: "wrappers",
      name: "ซองขนม / ซองเครื่องปรุง (เทเศษออกแล้ว)",
      image: "assets/wrappers.jpg",
      bin: "burnable",
      explanation: "ซองขนมหรือซองเครื่องปรุงที่เทเศษออกแล้ว เป็นขยะเชื้อเพลิง จึงใส่ถังสีเทา"
    },
    {
      id: "curry_bag",
      name: "ถุงแกง (เทเศษอาหารออกแล้ว)",
      image: "assets/curry_bag.jpg",
      bin: "burnable",
      explanation: "ถุงแกงที่เทเศษอาหารออกแล้ว เป็นขยะเชื้อเพลิง จึงใส่ถังสีเทา"
    },
    {
      id: "utensils",
    ...
    {
      id: "plastic_bottle",
      name: "ขวดน้ำพลาสติก (เทน้ำออกแล้ว)",
      image: "assets/plastic_bottle.jpg",
      bin: "recycle",
      explanation: "ขวดน้ำพลาสติกที่เทน้ำออกแล้ว สามารถนำไปรีไซเคิลได้ จึงใส่ถังสีเหลือง"
    },
    {
      id: "batteries",
      name: "ถ่านอัลคาไลน์",
  ...
  function loadPlayer() {
    try {
      const raw = sessionStorage.getItem("cgq5_player_session");
      if (!raw) return null;
  ...
  function savePlayer(player) {
    sessionStorage.setItem("cgq5_player_session", JSON.stringify(player));
  }
  ...
  $("#changePlayerButton").addEventListener("click", () => {
    stopAllGames();
    sessionStorage.removeItem("cgq5_player_session");
    state.player = null;
